...
int main(){
   ...
   cout << endl;  
    ...
    int testFrequency = 42;
    A.setValue(testWord, testFrequency);

    // Check if the test case was inserted successfully
    cout << "A.getValue(\"test\") = " << A.getValue("test") << endl;
    cout << endl;

    // Check state of A after inserting the test case
    cout << "A.size() = " << A.size() << endl  << A << endl;
    cout << "A pre-order: " << endl << A.pre_string() << endl;
