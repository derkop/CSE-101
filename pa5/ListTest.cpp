...
int main() {
   ...
   // // Test findNext/findPrev on empty list
   List emptyList;
   cout << "FindNext on empty list: " << emptyList.findNext(5) << endl;
   cout << "FindPrev on empty list: " << emptyList.findPrev(5) << endl;

   // Test front/back on empty list
   try {
      emptyList.front();
   } catch (std::length_error& e) {
      cout << "Front on empty list: " << e.what() << endl;
   }

   try {
      emptyList.back();
   } catch (std::length_error& e) {
      cout << "Back on empty list: " << e.what() << endl;
   }
